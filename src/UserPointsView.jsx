...
function UserPointsView() {
  ...
  const handleSearchPoints = async () => {
    ...
    try {
      // Search for patient by Email or HUID
      const searchTerm = searchHUID.trim();
      ...
      if (patientError || !patientData) {
        setError('User not found with this Email/ID: ' + searchHUID);
        setPatient(null);
        setPointsData(null);
        return;
      }
      ...
      <div className="user-points-wrapper">
        ...
        <div className="user-points-search">
          <div className="user-search-card">
            ...
            <p>Use your Email to view your points and redemption history</p>
            ...
            <div className="user-patient-card">
              <div className="user-patient-header">
                ...
                <div className="user-patient-info">
                  <h3>{patient.name}</h3>
                  <p>Email: {patient.email || patient.patient_code}</p>
            ...
            <div className="user-redemption-info">
              ...
              <div className="user-redemption-steps">
                ...
                <div className="user-redemption-step">
                  ...
                  <div className="user-step-content">
                    <h4>Present Your Email</h4>
                    <p>Show your registered Email: <strong>{patient.email || patient.patient_code}</strong></p>
                  </div>
                </div>
                <div className="user-redemption-step">
